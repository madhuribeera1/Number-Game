...
if(a>0 && a<4){
    ...
    document.querySelector('.text').innerHTML ="I AM ELDER "
}
...
function Cheatwin(){
    if(document.querySelector(".sheet").getAttribute('value')==1){
        ...
        document.querySelector(".cheat-image").style.opacity = "1";
        document.querySelector(".sheet").setAttribute('value',0);
        document.querySelector(".cheat-image").style.display='block';
    }
    else{
        document.querySelector('.sheet').innerHTML = "Cheat Sheet";
        document.querySelector(".container").style.opacity = "1";
        document.querySelector(".cheat-image").style.opacity = "0";
        document.querySelector(".sheet").setAttribute('value',1);
        document.querySelector(".cheat-image").style.display='none';
    }
}
